...
#读取目标图片
# target = cv2.imread("test/target.jpg")
#读取模板图片
# template = cv2.imread("test/template.jpg")
target   = cv2.imread("test/grey_sharp.jpg",0)
template = cv2.imread("test/icon.png",0)
#获得模板图片的高宽尺寸
...
cv2.rectangle(target,min_loc,(min_loc[0]+twidth,min_loc[1]+theight),(255,255,225),2)
#匹配值转换为字符串
